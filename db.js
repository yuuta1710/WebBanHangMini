...
// Kiểm tra môi trường chạy hiện tại (chỉ dùng để in log cho dễ theo dõi)
const isProduction = process.env.NODE_ENV === 'production';

// ✨ SỬA: Tự động BẬT SSL trừ khi Postgres đang chạy ngay trên máy local (localhost/127.0.0.1).
// Trước đây SSL bị ép bật cứng, gây lỗi kết nối khi test với Postgres cài trực tiếp trên máy (không hỗ trợ SSL).
// Dùng DATABASE_URL để nhận diện (thay vì chỉ dựa vào NODE_ENV) vì nếu test local bằng Postgres CLOUD
// miễn phí (Neon/Supabase/Render) - vốn BẮT BUỘC SSL - thì dù NODE_ENV=development vẫn cần giữ SSL bật.
